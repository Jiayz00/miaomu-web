...
export function Footer() {
  ...
  return (
    <footer className="bg-primary text-background/70">
      <div className="container-luxury py-20">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/bonsais" className="text-background/60 transition-colors hover:text-background">
                  盆景收藏
                </Link>
              </li>
              <li>
                <Link href="/categories" className="text-background/60 transition-colors hover:text-background">
                  分类浏览
                </Link>
              </li>
              <li>
                <Link href="/chat" className="text-background/60 transition-colors hover:text-background">
                  询价咨询
                </Link>
              </li>
              <li>
                <Link href="/favorites" className="text-background/60 transition-colors hover:text-background">
                  我的收藏
                </Link>
              </li>
            </ul>
        ...
        {/* 分隔线 + 版权 */}
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-background/10 pt-8 text-xs text-background/40 md:flex-row">
